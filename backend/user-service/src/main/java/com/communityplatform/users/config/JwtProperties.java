 ...
 * 
 * This class binds properties with prefix 'app.jwt' from application.properties
 * and provides type-safe, validated configuration.
 * 
 * Eliminates IDE warnings and enables autocomplete for custom properties.
 */
@Configuration
